"""
Django settings for yellow_moon_3 project.
...
ROOT_URLCONF = 'yellow_moon_3.urls'
...
WSGI_APPLICATION = 'yellow_moon_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_moon_3 API",
    "DESCRIPTION": "API documentation for yellow_moon_3 App",
    "VERSION": "v1",
}
